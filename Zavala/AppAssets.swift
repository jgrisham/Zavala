...
extension String {
	...
	static var deleteOutlineMessage = String(localized: "The outline will be deleted and unrecoverable.", comment: "Alert Message: delete outline")
	static var deleteOutlinesMessage = String(localized: "The outlines will be deleted and unrecoverable.", comment: "Alert Message: delete outline")
	...
	static var fixItControlLabel = String(localized: "Fix It", comment: "Control Label: Fix It")
